...
// Separar cada letra del texto y envolverla en un span
textoe.innerHTML = textoe.textContent.replace(/\S/g, "<span>$&</span>");
...
$("#boton").on("click",function(){
    ...
    document.getElementById("audio_inicio").play()
  ...
  function cambiar_imagen(jugada_cpu){
    if (parseInt(jugada_cpu) == 1){
      $("#img_cpu").attr("src","imagenes/piedra.png")
  
    }else if(parseInt(jugada_cpu) == 2){
      $("#img_cpu").attr("src","imagenes/papel.png")
  
    }else{
      $("#img_cpu").attr("src","imagenes/tijeras.png")
    }
  }
  ...
  $(".jugada").click(function(){
    ...
    $("#img_cpu").attr("src","imagenes/descarga.jpg")
  });
